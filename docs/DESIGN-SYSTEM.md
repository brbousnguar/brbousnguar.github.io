...
The favicon is the header's brand mark — an ink square with "BB" in paper,
Archivo ExtraBold, hard-edged — generated by `tools/make_favicons.py`
(`favicon.ico` 16/32/48, 32 and 192 PNGs, a 180px opaque Apple touch icon).
