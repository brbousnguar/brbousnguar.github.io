...
- `archived/` holds the source certificate PDFs, and `assets/js/*.py` the one-off scripts that turned them into the (now deleted) `learning-data.json`. Nothing on the site uses either any more.
